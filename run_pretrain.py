...
def main(argv):
  ...
  builder = PretrainDataset(data_dir=FLAGS.data_dir)
  download_cfg = tfds.download.DownloadConfig(try_download_gcs=False)
  builder.download_and_prepare(download_config=download_cfg)
